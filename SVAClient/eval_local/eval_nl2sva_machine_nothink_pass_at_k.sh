...
PROBLEM_NAME="nl2sva_machine"
TEMPLATE_PATH="configs/${PROBLEM_NAME}_local_nothink_template_pass_at_k.yaml"
RESULT_NAME="${PROBLEM_NAME}_${MODEL_NAME}_pass_at_k"
...
submit eval_local/machine.slurm $GPU_ID